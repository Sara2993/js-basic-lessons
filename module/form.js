		...
		function AddRow(){
			...
			list6[x] = document.getElementById("dot").value;
			list7[x] = document.getElementById("tot").value;
			list8[x] = document.getElementById("result").value;
			list9[x] = document.getElementById("lab-name").value;
			list10[x] = document.getElementById("report-number").value;
